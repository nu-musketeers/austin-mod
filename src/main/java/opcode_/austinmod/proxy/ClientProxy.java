...
package opcode_.austinmod.proxy;
...
import opcode_.austinmod.blocks.BlockLeavesCloud;
import opcode_.austinmod.client.gui.GuiCreateWorldMod;
import opcode_.austinmod.client.localization.ModLocale;
import opcode_.austinmod.networking.MessageExtendedReachAttack;
...
import opcode_.austinmod.MainMod;
import opcode_.austinmod.client.renderers.ModRenderArmorStand;
import opcode_.austinmod.client.renderers.ModRenderGiantZombie;
import opcode_.austinmod.client.renderers.ModRenderHusk;
import opcode_.austinmod.client.renderers.ModRenderItem;
import opcode_.austinmod.client.renderers.ModRenderPigZombie;
import opcode_.austinmod.client.renderers.ModRenderPlayer;
import opcode_.austinmod.client.renderers.ModRenderSkeleton;
import opcode_.austinmod.client.renderers.ModRenderStray;
import opcode_.austinmod.client.renderers.ModRenderWitherSkeleton;
import opcode_.austinmod.client.renderers.ModRenderZombie;
import opcode_.austinmod.client.renderers.ModRenderZombieVillager;
import opcode_.austinmod.client.renderers.RenderFactories;
import opcode_.austinmod.init.ModBlockColors;
import opcode_.austinmod.init.ModKeyBindings;
import opcode_.austinmod.init.ModMaterials;
import opcode_.austinmod.init.ModNetworking;
import opcode_.austinmod.init.ModWorldGen;
import opcode_.austinmod.items.IExtendedReach;
...
public class ClientProxy implements IProxy
{
    ...
    /* (non-Javadoc)
     * @see IProxy#preInit(net.minecraftforge.fml.common.event.FMLPreInitializationEvent)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see IProxy#init(net.minecraftforge.fml.common.event.FMLInitializationEvent)
     */
    ...
    /* (non-Javadoc)
     * @see IProxy#postInit(net.minecraftforge.fml.common.event.FMLPostInitializationEvent)
     */
    @Override
...
//        Minecraft.getMinecraft().refreshResources();
    ...
    /* (non-Javadoc)
     * @see IProxy#getPlayerEntityFromContext(net.minecraftforge.fml.common.network.simpleimpl.MessageContext)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see IProxy#handleMaterialAcceleration(net.minecraft.entity.Entity, net.minecraft.block.material.Material)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see IProxy#serverStarting(net.minecraftforge.fml.common.event.FMLServerStartingEvent)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see IProxy#setGraphicsLevel(BlockLeavesCloud, boolean)
     */
    @Override
